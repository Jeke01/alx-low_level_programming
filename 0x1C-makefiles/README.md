...
Tests ✔️
tests: This is the Folder of test files.
Helper Files 🙌

school.c: This iis the C function that displays a seahorse in text. This was used for Makefile practice purposes throughout project.

main.c: This is the Main C function that runs the function defined in school.c.
